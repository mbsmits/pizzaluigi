	...
	<nav>
		<ul>
			...
			<li><a href="<c:url value='/pizzas/tussenprijzen.htm'/>">Pizza's
					tussen prijzen</a></li>
			<li><a href="<c:url value='/pizzas/voorkeuren.htm'/>">Voorkeurpizza's</a>
			</li>
			<li><a href="<c:url value='/pizzas/toevoegen.htm'/>">Pizza
					toevoegen</a></li>
			<li><a href="<c:url value='/identificatie.htm'/>">Identificatie</a>
			</li>
			<li><a href="<c:url value='/headers.htm'/>">Headers</a></li>
			<li><a href="<c:url value='/pizzas/bestellen.htm'/>">Bestellen</a>
			</li>
		</ul>
	</nav>
</header>
