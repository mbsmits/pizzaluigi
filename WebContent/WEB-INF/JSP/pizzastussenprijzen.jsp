...
<body>
	...
	<form>
		<label> Van prijs <span>${fouten.van}</span> <input name='van'
			value='${param.van}' autofocus type='number' min='0' required>
		</label> <label> Tot prijs <span>${fouten.tot}</span> <input
			name='tot' value='${param.tot}' type='number' min='0' required>
